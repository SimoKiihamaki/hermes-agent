...
def check_packages():
    ...
    # Optional: local STT
    try:
        import faster_whisper  # noqa: F401 - imported for availability check
    ...
    try:
        import edge_tts  # noqa: F401 - imported for availability check
        check("edge-tts", True)
    except ImportError:
        warn("edge-tts", "not installed — edge TTS unavailable")

    try:
        import elevenlabs  # noqa: F401 - imported for availability check
